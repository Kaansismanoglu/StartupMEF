...
<html>
	<head>
		...
		<title>StartupMEF Pazarlama Ekibi Kayıt Form</title>
		<meta charset="utf-8" />        
...
<body>
            <!-- multistep form -->
            <form id="msform" method="post" action="pazarlamaekibi.php">
            <!-- progressbar -->
            <ul id="progressbar">
            ...
            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title">Pazarlama Ekip Üyesi Kayıt</h2>
            ...
            <fieldset>
                ...
                <textarea type="text" name="yorum" placeholder="Bir ürünü pazarlamada hangi 3 sosyal medya platformunun daha etkili olduğunu düşünüyorsun?" required></textarea>
                <textarea type="text" name="pazarlama" placeholder="Bir etkinliği pazarlamak için dikkat edeceğin 3 şey nedir?" required></textarea>

                <textarea type="text" name="eklemek" placeholder="Bu ekibe katılmak istemendeki motivasyonun nedir?" required></textarea>
...
if(isset($_POST["name"], $_POST["surname"], $_POST["class"], $_POST["email"], $_POST["telefon"], $_POST["squad"], $_POST["kulup"], $_POST["beklenti"], $_POST["deneyimyon"], $_POST["pazarlama"],  $_POST["yorum"], $_POST["eklemek"])){
    ...
    $ekle = "INSERT INTO Pazarlamaekibi (Adin, Soyadin, Sinifin, Mail_Adresin, Telefon_Numaran, Squad, deneyimyon, Hangi_kulup, Beklenti, Sosyal_medya, Pazarlama, eklemek) VALUES ('".addslashes($ad)."','".addslashes($soyad)."','".addslashes($sınıf)."','".addslashes($email)."','".addslashes($tel)."','".addslashes($squad)."','".addslashes($deneyimyon)."','".addslashes($kulup)."','".addslashes($beklenti)."','".addslashes($yorum)."','".addslashes($pazarlama)."','".addslashes($eklemek)."')";
