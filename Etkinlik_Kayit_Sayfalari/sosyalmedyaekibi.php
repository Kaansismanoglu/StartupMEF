...
<html>
	<head>
		...
		<title>StartupMEF Sosyal Medya Ekibi Kayıt Form</title>
		<meta charset="utf-8" />        
...
<body>
            <!-- multistep form -->
            <form id="msform" method="post" action="sosyalmedyaekibi.php">
            <!-- progressbar -->
            <ul id="progressbar">
            ...
            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title">Sosyal Medya Ekip Üyesi Kayıt</h2>
            ...
            <fieldset>
                ...
                <SELECT type="text" name="deneyim" required>
                    <OPTION value="" disabled selected>Sosyal medya yönetimi ve dizaynı hakkında önceden staj veya proje deneyimin oldu mu?</option>
                    <OPTION> Evet
                    <OPTION> Hayır
                </SELECT>
                ...
                <textarea type="text" name="sosyalmedya" placeholder="Seni etkileyen en çok etkileyen 3 Instagram sayfası ve nedeni?" required></textarea>
                <textarea type="text" name="yorum" placeholder="StartupMEF Instagram hesabımızı yorumlayacak olsan bizlere ne söylemek isterdin?" required></textarea>
...
if(isset($_POST["name"], $_POST["surname"], $_POST["class"], $_POST["email"], $_POST["telefon"],$_POST["deneyimbah"], $_POST["squad"], $_POST["deneyim"], $_POST["kulup"], $_POST["beklenti"], $_POST["deneyimyon"], $_POST["sosyalmedya"],  $_POST["yorum"], $_POST["eklemek"])){
    ...
    $ekle = "INSERT INTO Sosyalmedyaekip (Adin, Soyadin, Sinifin, Mail_Adresin, Telefon_Numaran, Squad, Daha_once_deneyim, deneyimbah, Beklenti, Hangi_sosyalmedya, Insta_yorum, deneyimyon , Hangi_kulup, eklemek) VALUES ('".addslashes($ad)."','".addslashes($soyad)."','".addslashes($sınıf)."','".addslashes($email)."','".addslashes($tel)."','".addslashes($squad)."','".addslashes($deneyim)."','".addslashes($deneyimbah)."','".addslashes($beklenti)."','".addslashes($sosyalmedya)."','".addslashes($yorum)."','".addslashes($deneyimyon)."','".addslashes($kulup)."','".addslashes($eklemek)."')";
